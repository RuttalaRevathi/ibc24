...
export const Jabalpur = 'jabalpur';
export const Gwalior = 'gwalior';
export const Raipur = 'raipur';
export const Bilaspur = 'bilaspur';

// States
export const Chhattisgarh = 'chhattisgarh';
export const Madhyapradesh = 'madhya-pradesh';
export const Bihar = 'bihar';
export const Uttarpradesh = 'uttar-pradesh';
export const Maharashtra = 'maharashtra';
export const Himachalpradesh = 'himachal-pradesh';
